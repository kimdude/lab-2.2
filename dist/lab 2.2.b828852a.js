...
if (list != null) getData();
//Adding eventlisteners
if (submitBtn != null) submitBtn.addEventListener("click", addExpirience);
//Fetching data
async function getData() {
    ...
    try {
        ...
        if (!response.ok) throw new Error('An error occurred. Invalid answer from server.');
...
async function editExp(data, e) {
    ...
    let startNode = document.createTextNode("Fr\xe5n: ");
...
},{}]},["93v64","lhpGb"], "lhpGb", "parcelRequiree5ad", {})

//# sourceMappingURL=lab 2.2.b828852a.js.map
